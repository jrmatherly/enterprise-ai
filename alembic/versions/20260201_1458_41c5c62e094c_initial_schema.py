...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('ORGANIZATION', 'DEPARTMENT', 'TEAM', name='tenanttype'), nullable=False),
    ...
    sa.Column('scope', sa.Enum('ORGANIZATION', 'DEPARTMENT', 'TEAM', 'PERSONAL', name='knowledgebasescope'), nullable=False),
