    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-shrink-0 border-t border-neutral-800 p-3">
        <div className="flex items-center gap-3 rounded-lg px-2 py-2">
          <div className="flex size-8 items-center justify-center rounded-full bg-neutral-700 text-xs font-medium text-neutral-300">
            U
          </div>
          <div className="min-w-0 flex-1">
            <div className="truncate text-sm font-medium text-neutral-200">User</div>
            <div className="text-xs text-neutral-500">Enterprise AI</div>
          </div>
        </div>
      </div>
    </div>
