...
function KBSettingsSection({ kb }: { kb: { id: string; system_prompt: string | null; grounded_only: boolean } }) {
	...
	return (
		<div className="mb-8 rounded-xl border border-neutral-800 bg-neutral-900/50">
			<button
				type="button"
			...
			>
				...
				<svg
					className={cn("size-5 text-neutral-500 transition-transform", isExpanded && "rotate-180")}
					fill="none"
					viewBox="0 0 24 24"
					stroke="currentColor"
					strokeWidth={2}
				...
				<div className="border-t border-neutral-800 px-5 py-4 space-y-6">
					...
					<div>
						<div className="mb-2 flex items-center justify-between">
							...
							<a
								href="https://raw.githubusercontent.com/jrmatherly/enterprise-ai/refs/heads/main/docs/reference/KB-CUSTOM-INSTRUCTIONS-TEMPLATE.md"
								target="_blank"
